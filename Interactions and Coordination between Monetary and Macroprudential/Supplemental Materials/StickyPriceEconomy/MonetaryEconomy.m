%% STICKY PRICE ECONOMY WITHOUT MACRO-PRUDENTIAL POLICY
% This code computes (and saves) the Markov equilibrium in the sticky price economy without macro-prudential policy.
...
phi_E = phi; a_E = a; q_E = (l/l_F).^alpha.*a.^(1-alpha).*q; mu_x_E = mu_x; sigma_x_E = sigma_x;  sigma_y_E = sigma_y;  sigma_q_E = sigma_q; p_x_E = p_x; cdf_a_E = cdf_a; v_E = v;
wedge_E = wedge; l_E = l; r_E = r_k; pi_E = pi; x_E = x_L; CE_E = CE; CE_gain_E = CE_gain;

save SociallyOptimalMonetaryPolicyFigure x x_L a_E phi_E q_E mu_x_E sigma_x_E sigma_y_E sigma_q_E p_x_E cdf_a_E v_E wedge_E l_E r_E pi_E x_E CE_E CE_gain_E SW_A SW_G mu_x sigma_x pi a
